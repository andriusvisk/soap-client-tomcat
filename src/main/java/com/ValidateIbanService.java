    ...
    extends Service
{
     ...
     * 
     * @return
     *     returns ValidateIbanInt
     */
    @WebEndpoint(name = "ValidateIbanPort")
    public ValidateIbanInt getValidateIbanPort() {
        return super.getPort(new QName("http://soap/", "ValidateIbanPort"), ValidateIbanInt.class);
    }
     ...
     */
    @WebEndpoint(name = "ValidateIbanPort")
    public ValidateIbanInt getValidateIbanPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap/", "ValidateIbanPort"), ValidateIbanInt.class, features);
    }
